...
$merchantData = urlencode("테스트 주문"); // 가맹점 임의 데이터 (한글 입력 시 urlencoding 필요)
...
/* 기타 */
$siteDomain = "http://localhost/stdpay/WelStdPaySample"; //가맹점 도메인 입력
// 페이지 URL에서 고정된 부분을 적는다. 
// Ex) returnURL이 http://localhost:8080/stdpay/WelpayStdSample/WelStdPayReturn.php 라면
//                 http://localhost:8080/stdpay/WelpayStdSample 까지만 기입한다.
?>
<!DOCTYPE html>
<html>
    <head>
                                        ...
                                        <td style="text-align:left;">
                                            <form id="SendPayForm_id" name="" method="POST">
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><b>goodname</b> :
                                                    <br/><input  style="width:100%;" name="goodname" value="Test Goods" >
                                                    ...
                                                    <br/><b>buyername</b> :
                                                    <br/><input  style="width:100%;" name="buyername" value="Hong gildong" >

                                                    <br/><b>buyertel</b> :
                                                    <br/><input  style="width:100%;" name="buyertel" value="010-1234-5678" >

                                                    <br/><b>buyeremail</b> :
                                                    <br/><input  style="width:100%;" name="buyeremail" value="test@paywelcome.co.kr" >
                                                    ...
                                                    <br/><b>returnUrl</b> :
                                                    <br/><input  style="width:100%;" name="returnUrl" value="<?php echo $siteDomain ?>/WelStdPayReturn.php" >
                                                    <!--
                                                    payViewType이 popup일 경우 ccrossDomain이슈 발생할 수 있음											
                                                    -->
                                                ...
                                                <div style="border:2px #cccccc solid;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <!--카드 분담 무이자 여부 설정(별도 카드사와 계약한 가맹점에서 직접 설정 예시: 11-2:3,34-5:12,14-6:12:24,12-12:36,06-9:12,01-3:4)-->
